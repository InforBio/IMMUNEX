...
sample_ids = ['IMMUNEX001', 'IMMUNEX004', 'IMMUNEX012', 'IMMUNEX015']

# Automatically find the TIFF file for one of the known samples
tiff_path = None
for sample_id in sample_ids:
    pattern = os.path.join(tiff_root, f"{sample_id}*_HE_x40_z0.tif")
...
if not tiff_path:
    raise FileNotFoundError("No matching TIFF file found for any of the sample IDs: " + ", ".join(sample_ids))
...
plt.imshow(img)
plt.savefig(os.path.join("/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation", "figure_{len(os.listdir('/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation'))}.png"))
...
# plt.imshow(img)
# plt.tight_layout()
# plt.savefig(f"image_preview.png", dpi=150)
# # plt.savefig(os.path.join("/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation", "figure_{len(os.listdir('/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation'))}.png"))
# plt.close()
...
# plt.savefig(f"tissue_mask.png", dpi=150)
# plt.savefig(os.path.join("/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation", "figure_{len(os.listdir('/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation'))}.png"))
...
# plt.savefig(f"tissue_mask_clean.png", dpi=150)
# plt.savefig(os.path.join("/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation", "figure_{len(os.listdir('/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation'))}.png"))
...
# plt.axis('off')
# plt.tight_layout()
# plt.savefig(f"tissue_mask_overlay.png", dpi=150)
# plt.savefig(os.path.join("/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation", "figure_{len(os.listdir('/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation'))}.png"))
...
# # Save and show
# plt.tight_layout()
# plt.savefig(f"{outdir}segmentation_plot_{prob_thresh}.png", dpi=200)
# plt.savefig(os.path.join("/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation", "figure_{len(os.listdir('/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation'))}.png"))
...
plt.tight_layout()
plt.savefig(f"{outdir}rejected_segmentations_{prob_thresh}.png", dpi=111)
plt.savefig(os.path.join("/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation", "figure_{len(os.listdir('/scratch/Projects/IMMUNEX/results/intermediate/stardist_segmentation'))}.png"))
plt.close()
...
ax.set_title("Visium Crop (±20 bins) Colored by Nucleus")
ax.set_xlabel("X")
ax.set_ylabel("Y")
ax.invert_yaxis()
plt.axis('equal')
