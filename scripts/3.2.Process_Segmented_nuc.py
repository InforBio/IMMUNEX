...
for sample_id, path in tqdm(h5ad_paths, desc="Loading samples"):
    if sample_id in to_skip:
        ...
        output_base_dir = "/scratch/Projects/IMMUNEX/results/intermediate/segmented_adatas_nuc/"
        ...
        # Aggregation of bins
        adata_filtered.obs['cell_id'] = adata_filtered.obs['labels_he'].astype(str)
        adata_cells = adata_filtered[adata_filtered.obs['labels_he'] > 0].copy()
        ...
        file_path = os.path.join(sample_output_dir, f"adata_{sample_id}_nuc.h5ad")
