...
PANEL_NSCLC = {
    ...
    # New compact roll-ups
    "Immune cells": [
        "PTPRC","CD3D","MS4A1","NKG7","GNLY","LYZ","LST1","FCGR3A",
        "CCR7","CXCR5","PDCD1","MRC1","CD163","XCR1","CD1C"
    ],
    "Tumor": [
        "EPCAM","KRT8","KRT18","KRT19","KRT7","MUC1","KRT17","TACSTD2","ERBB2","CEACAM6"
    ],
    "Stromal": [
        "COL1A1","COL1A2","PDGFRB","DCN","VIM","ACTA2","TAGLN","PDGFRA","FAP","ITGB1"
    ],
}

# P.A. panel (exactly as provided)
PANEL_PA = {
    ...
    "B_cells": ["AKNA","ARHGAP25","CCL21","CD180","CD2","CD27","CD37","CD38","CLEC17A","CLEC9A","CLECL1",
                "FAIM3","FAM65B","GIMAP4","MAP4K1","PAX5","TNFRSF17","TRAF3IP3"],
    "Dendritic_cells": ["CD209","S100A1","S100A10","S100A11","S100A12","S100A13","S100A14","S100A16","S100A2","S100A3",
                        "S100A4","S100A5","S100A6","S100A7","S100A7L1","S100A8","S100A9","S100B","S100G","S100P","S100PBP","S100Z"],
    "Activated_CD4_T_cell": ["ANLN","BRIP1","BUB1B","CASC5","CCNB1","CCNB2","CCNE2","CEP55","CKAP2L","DLGAP5","DTL","E2F8",
                             "ECT2","ESCO2","EXO1","EXOC6","FBXO5","FIGNL1","HELLS","HMMR","IARS","KIF11","KIF18A","KIF20A",
                             "KNTC1","MAD2L1","MASTL","MTHFD2","NCAPG2","NCAPH","NEIL3","NUF2","PRC1","PSAT1","RTKN2"],
    "Activated_CD8_T_cell": ["ADRM1","AHSA1","C1GALT1C1","CCT5","CCT6B","CETN3","CSE1L","EIF2S1","GAL","GEMIN6","GPT2",
                             "KIAA0101","MND1","MPZL1","MRPS16","PCNA","PTRH2","RFC5","SPC25","TIMM13","TIMM8B","TK1","TUBB","TXNDC17"],
    "Myeloid cells": ["FCGR3A","FCN1","FCGR3A","FCN1","CD68","MSR1","APOE","C1QA","XCR1","CLEC9A","CD1C","CLEC10A","FCER1A",
                      "LILRA4","SPIB","IRF7","KIT","CPA3"],
    ...
    "Neutrophils": ["ABTB1","AMPD2","CAMP","EMR4P","FPR1","FPR2","GPR77","MAEA","PROK2","SEC14L1","SEPX1",
                    "SLC25A37","TNFSF14","TREML4","VNN2","XPO6"],
...
# panel selector + cell-type (defaults to Tumor if present)
